class ProfileController < ApplicationController
  ...
  def show
    gon.contributions = @geography.aggregations.select("familycomposition, house_cost, childcare_cost, health_cost, food_cost, trans_cost, other_cost, minwage_hrly, income_hrly, poverty_hrly, income, tax, income_pretax_hrly")
